...
\begin{frame}
	...
	\begin{minipage}[t]{0.45\textwidth}
		\vspace{0pt}
		\begin{itemize}
			\item<1-> Inverted Index: Every edge $e$ has a list of trajectories going over it. Associate a trajectory with all edges of its shortest path representation in $E^+$.
		\end{itemize}
	\end{minipage}
\end{frame}
