...
\begin{frame}
	...
	\begin{minipage}[t]{0.45\textwidth}
		...
		\begin{itemize}
			...
			\item<2->$\Rightarrow$ huge and growing volume of trajectory data
			\item<3-> applications:
			      \begin{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\item novel data structure \pathfinder
		      \begin{itemize}
			      \item compressing and storing large-scale trajectory data (hundreds of millions of trajectories)
			      \item efficient retrieval from this data (~5 ms per reported trajectory)
		      \end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{minipage}[t]{0.45\textwidth}
		\vspace{0pt}
		\begin{itemize}
			\item<2->associate trajectory with all its edges
