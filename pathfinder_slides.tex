...
\begin{frame}
	...
	\begin{minipage}[t]{0.4\textwidth}
		\includegraphics<1>[keepaspectratio,height=.8\textheight,width=.8\textwidth]{graphics/saarland_real_data_1.png}
		\includegraphics<2>[keepaspectratio,height=.8\textheight,width=.8\textwidth]{graphics/saarland_real_data_2.png}
		\includegraphics<3>[keepaspectratio,height=.8\textheight,width=.8\textwidth]{graphics/saarland_real_data_3.png}
		\includegraphics<4>[keepaspectratio,height=.8\textheight,width=.8\textwidth]{graphics/saarland_real_data_4.png}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.5\textwidth}
		\vspace{0pt}\raggedright
